...
grep -Fq "var_os=\"\${var_os:-debian}\"" "$repo_dir/ct/scout.sh"
grep -Fq "var_version=\"\${var_version:-13}\"" "$repo_dir/ct/scout.sh"
grep -Fq "var_unprivileged=\"\${var_unprivileged:-1}\"" "$repo_dir/ct/scout.sh"
