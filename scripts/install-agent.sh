...
agent_url_placeholder="__SCOUT_"'SERVER_URL__'
...
[[ "$agent_server_url" != "$agent_url_placeholder" ]] || fail "server URL was not embedded; use a current Scout installer or provide --server/SCOUT_SERVER_URL"
