  ...
  async function submit(event: FormEvent) {
    ...
    try {
      if (setupMode) {
        ...
        setSetupMode(false);
        setMessage("Owner created. Sign in to continue.");
      } else {
      ...
      <section className="auth-card" aria-labelledby="auth-title">
        ...
        <form onSubmit={submit}>
          ...
          {!setupMode && (
            <>
              <label>
                Authenticator code <span className="label-hint">if enabled</span>
                <Input
                  inputMode="numeric"
                  autoComplete="one-time-code"
                  value={totpCode}
              ...
              <label>
                Recovery code <span className="label-hint">alternative</span>
        ...
        >
          {setupMode ? "Owner already exists? Sign in" : "First run? Set up owner"}
        </button>
      </section>
    </main>
  );
